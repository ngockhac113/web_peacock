        ...
        <?php foreach ($content as $row) : ?>
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <p style="text-align:justify;" ><?= $row['content1'] ?></p>
                    <p style="text-align:justify;"><?= $row['content2'] ?></p>
                </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <p class="text-center leads">Chúng tôi là những kĩ sư tài năng với niềm đam mê với thời trang.</p>
            </div>
        </div>
        <div class="row justify-content-center">
                ...
                <div class="col-lg-2 col-sm-6">
                    <div class="team_box team_style1">
                        <div class="team_img">
                            ...
                            <!-- <img src="<?= $row['image'] ?>" alt="team_img1">  -->

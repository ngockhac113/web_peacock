                ...
                <div class="col-xl-4 col-md-6">
                    <div class="contact_wrap contact_style3">
                        ...
                        <div class="contact_text">
                            ...
                            <a href="mailto:info@sitename.com">CSKH@gear9.com</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <?php elseif ($message == "fail") : ?>
                                <div class="alert alert-danger">
                                    <strong>Gửi không thành công !</strong> Vui lòng liên hệ email CSKH@gear9.com hoặc số điện thoại 0981173413 để thêm thông tin.
                                </div>
                            <?php endif; ?>
                        </div>
                ...
                <div class="col-lg-6 pt-2 pt-lg-0 mt-4 mt-lg-0">
                    <div id="map" class="contact_map2" data-zoom="16" data-latitude="20.9883541" data-longitude="105.7953723" data-icon="assets/images/marker.png"></div>
                </div>
            </div>
        </div>
    </div>

...
<footer class="footer_dark">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="widget">
                        <div class="footer_logo">
                            <a href="#"><img style="height: 125px;" src="<?= base_url() ?>/public/client/assets/images/thiet-ke-logo-thoi-trang-08.jpg" alt="logo"></a>
                        </div>
                        <ul class="contact_info">
                            ...
                            <li>
                                <i class="ti-email"></i>
                                <a href="mailto:CSKH@gear16.com">CSKH@gear9.com</a>
                            </li>
                            <li>
                                <i class="ti-mobile"></i>
                                <p>098 117 3413</p>
    ...
    <div class="bottom_footer border-top-tran">
        <div class="custom-container">
            <div class="row">
                <div class="col-lg-4">
                    <p class="mb-lg-0 text-center">© 2020 All Rights Reserved by Nhom 9</p>
                </div>

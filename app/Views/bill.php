         ...
         <div class="row">
                <?php if ($message == "success") : ?>
                    <div class="alert alert-success">
                       <strong><b >Cập nhật đơn hàng thành công! </b></strong>
                    </div>
                <?php elseif ($message == "fail") : ?>
                    <div class="alert alert-danger">
                        <strong><b>Cập nhật đơn hàng không thành công !</b></strong> Vui lòng liên hệ email CSKH hoặc số điện thoại 038-564-3624 để thêm thông tin.
                    </div>
                <?php endif; ?>
            </div>
            <div class="row">
    ...
    <thead>
     ...
     <tbody id="myTable">
                ...
                <tr>
                    ...
                    <td><?php if($row['status']==0) echo "<b><font color=red size='2pt'>Đã hủy </font></b>";else echo"<b> <font color=blue size='2pt'>On-going</font></b>";?></td>
                   
                    <td>
                        <div class="obj-action">
                            <div class="ac">

                                <a href="<?php echo base_url().'/bill/detail?id='.$row['id']?>" data-toggle="tooltip" data-placement="bottom"
                            ...
                            <?php if($row['paid_status']==0 && $row['status']==1) : ?>
                               ...
                               <div class="ac">
                                ...
                                <a href="<?php echo base_url().'/bill/edit?id='.$row['id']?>"  data-toggle="tooltip" data-placement="bottom" title="Sửa"><i class="far fa-edit"></i> </a>
                            </div>
                            <?php endif ?>
                            ...
                            <?php if($row['paid_status']==0 && $row['status']==1) : ?>
                                ...
                                <div class="ac">
                                    <a href="<?php echo base_url().'/bill/delete?id='.$row['id']?>" onclick="return confirm('Are you sure?');" data-toggle="tooltip" data-placement="bottom"
